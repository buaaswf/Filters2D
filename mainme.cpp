 ...
 void testRaw2DTrilaterlfilter()
{
	...
	test.readImage(indata,"E:\\geodata\\mig.raw",l*m*sizeof(unsigned char));
	...
	ret=(Image2D*)doTrilateralfilterI2D_new(*src,*tri);
 ...
 void testRaw2DGaussFilter()
 {
	 ...
	 ret=(Image2D*)doGuassFilterI2D_new(*src,*tri);
 ...
 void testRaw2DBilateralFilter()
 {
	 ...
	 ret=(Image2D*)doBilateralI2D_new(*src,*tri);
